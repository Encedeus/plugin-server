...
func (x *UserAuthorizeResponse) GetAccessToken() string {
	if x != nil {
...
var file_auth_api_proto_rawDesc = []byte{
	...
	0x22, 0x5b, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x22, 0x39, 0x0a, 0x15, 0x55, 0x73, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a,
	...
	0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x0f, 0x5a, 0x0d, 0x2e,
...
var file_auth_api_proto_goTypes = []interface{}{
	...
	(*UserAuthorizeResponse)(nil), // 2: UserAuthorizeResponse
}
...
func file_auth_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAuthorizeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
